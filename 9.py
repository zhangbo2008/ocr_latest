...
left=out_for_fullname2[0][1]-dangezifuchangdu*6
print('图片位置left',left)
...
up=out_for_fullname2[0][0]-dangezifugaodu*2
print('图片位置up',up)
down=out_for_fullname2[0][0]-dangezifugaodu*33
print('图片位置down',down)
